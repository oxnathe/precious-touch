      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="mx-auto mt-4 max-w-4xl font-oswald text-5xl font-semibold uppercase leading-[0.92] tracking-tight sm:text-6xl lg:text-7xl">
              Let’s make your
            ...
            <p className="mx-auto mt-6 max-w-2xl font-poppins text-sm leading-7 text-white/55 sm:text-base">
              Tell us what you need, and let’s find the right cleaning or
